...
var UserPage = (function () {
    ...
    UserPage.prototype.nfcConnect = function () {
        var _this = this;
        this.nfc.addNdefListener(function () {
            ...
            var message = _this.ndef.textRecord(null, null, 'Hello world');
            console.log(message);
        });
    };
...
var AuthService = (function () {
    ...
    AuthService.prototype.adduser = function (user) {
        ...
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        return new Promise(function (resolve) {
            _this.http.post('http://localhost:3333/adduser', creds, { headers: headers }).subscribe(function (data) {
                if (data.json().success) {
                    resolve(true);
                }
                else
...
var HomePage = (function () {
    ...
    HomePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__services_authservice__["a" /* AuthService */]])
    ], HomePage);
    return HomePage;
}());
